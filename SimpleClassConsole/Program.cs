...
namespace SimpleClassConsole
{
    class Product
    {
        ...
        {
            Console.WriteLine($"Дата придатності в днях: {expirationDate}\n");
            Console.WriteLine($"Дата придатності в місяцях: {expirationDate/30}\n");
            Console.WriteLine($"Дата придатності в роках: {expirationDate/365}\n");
        }
        public void setExpirationDate()
        {
            ...
            Console.WriteLine("В якій одиниці вимірювання вводити термін придатності? \n 1. Добах.\n 2. Місяцях. \n 3. Роках");
